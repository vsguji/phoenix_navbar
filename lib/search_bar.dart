...
class SearchAppbar extends PreferredSize {
  ...
  @override
  Widget get child => PhoenixAppBar(
  ...
  Size get preferredSize =>
      const Size.fromHeight(phoenix.AppBarTheme.appBarHeight);
  ...
  Widget _createSearchChild(AppBarConfig themeData) {
    return Row(
