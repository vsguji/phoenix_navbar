...
class PhoenixAppBar extends PreferredSize {
  ...
  Size get preferredSize {
    AppBarConfig _defaultConfig = themeData ?? AppBarConfig();
    _defaultConfig = BaseThemeConfig.instance
  ...
  Widget build(BuildContext context) {
    AppBarConfig _defaultConfig = themeData ?? AppBarConfig();
    _defaultConfig = _defaultConfig.merge(AppBarConfig(
        backgroundColor: backgroundColor,
        showDefaultBottom: showDefaultBottom,
  ...
  PreferredSizeWidget? _buildBarBottom(AppBarConfig defaultConfig) {
  ...
  double _culLeadingSize(AppBarConfig themeData) {
  ...
  List<Widget>? _wrapActions(AppBarConfig themeData) {
...
class BackLeading extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    AppBarConfig _defaultThemeData = themeData ?? AppBarConfig();
    _defaultThemeData = BaseThemeConfig.instance
...
class BrnIconAction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _defaultThemeData = BaseThemeConfig.instance
        ...
        .appBarConfig
        .merge(_defaultThemeData)
        .merge(AppBarConfig(iconSize: size));
    return ConstrainedBox(
      constraints: BoxConstraints.tightFor(
          width: _defaultThemeData.iconSize,
...
class _BrnSearchResultAppBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    AppBarConfig _defaultConfig = appBarConfig ?? AppBarConfig();
    _defaultConfig = _defaultConfig.merge(AppBarConfig(
      backgroundColor: backgroundColor,
      showDefaultBottom: showDefaultBottom,
    ));
